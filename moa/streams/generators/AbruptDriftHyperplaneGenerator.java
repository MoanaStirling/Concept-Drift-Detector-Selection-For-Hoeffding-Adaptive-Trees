/*
 *    AbruptDriftHyperplaneGenerator.java
 ...
 * @version $Revision: 7 $
 */
public class AbruptDriftHyperplaneGenerator extends AbstractOptionHandler implements
        InstanceStream {
    ...
    private boolean originalClassification = true;
    ...
    public IntOption instancesBeforeChangeOption = new IntOption("instancesBeforeChange",
            'x', "Number of instances before classification is reversed", 1000, 0, Integer.MAX_VALUE);
