...
import moa.classifiers.core.driftdetection.PageHinkley;
 ...
 *
 * <p>This adaptive Hoeffding Tree uses PageHinkley to monitor performance of
 ...
 * @version $Revision: 7 $
 */
public class HoeffdingPageHinkleyTree extends HoeffdingTree {
    ...
    public String getPurposeString() {
        return "Hoeffding Adaptive Tree for evolving data streams that uses PageHinkley to replace branches for new ones.";
    }
    ...
    public FloatOption deltaOption = new FloatOption("delta", 'w',
            "Delta parameter of the Page Hinkley Test", 0.005, 0.0, 1.0);

    public FloatOption lambdaOption = new FloatOption("lambda", 'x',
            "Lambda parameter of the Page Hinkley Test", 50, 0.0, Float.MAX_VALUE);

    public FloatOption alphaOption = new FloatOption("alpha", 'y',
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HoeffdingPageHinkleyTree ht);

        public void learnFromInstance(Instance inst, HoeffdingPageHinkleyTree ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        protected PageHinkley estimationErrorWeight;
        ...
        public void learnFromInstance(Instance inst, HoeffdingPageHinkleyTree ht, SplitNode parent, int parentBranch) {
            ...
            if (this.estimationErrorWeight == null) {
                this.estimationErrorWeight = new PageHinkley(ht.deltaOption.getValue(), ht.alphaOption.getValue(), ht.lambdaOption.getValue(), ht.minNumInstancesOption.getValue());
            }
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
            double[] dist;
            int predictionOption = ((HoeffdingPageHinkleyTree) ht).leafpredictionOption.getChosenIndex();
