...
import moa.classifiers.core.driftdetection.SEED;
 ...
 *
 * <p>This adaptive Hoeffding Tree uses SEED to monitor performance of
 ...
 * @version $Revision: 7 $
 */
public class HoeffdingSeedTree extends HoeffdingTree {
    ...
    public String getPurposeString() {
        return "Hoeffding Seed Tree for evolving data streams that uses SEED to replace branches for new ones.";
    }

    public FloatOption deltaSEEDOption = new FloatOption("deltaSEED", 'v', "Delta value of SEED Detector", 0.05, 0.0, 1.0);
    public IntOption blockSizeSEEDOption = new IntOption("blockSizeSEED", 'w', "BlockSize value of SEED Detector", 32, 32, 256);
    public FloatOption epsilonPrimeSEEDOption = new FloatOption("epsilonPrimeSEED", 'x', "EpsilonPrime value of SEED Detector", 0.01, 0.0025, 0.01);
    public FloatOption alphaSEEDOption = new FloatOption("alphaSEED", 'y', "Alpha value of SEED Detector", 0.8, 0.2, 0.8);
    public IntOption compressTermSEEDOption = new IntOption("compressTermSEED", 'u', "CompressTerm value of SEED Detector", 75, 50, 100);
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HoeffdingSeedTree ht);

        public void learnFromInstance(Instance inst, HoeffdingSeedTree ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        protected SEED estimationErrorWeight;
        ...
        @Override
        public double getErrorEstimation() {
            return this.estimationErrorWeight.window.getTotal() / this.estimationErrorWeight.window.getWidth();
        }
        ...
        public double getErrorWidth() {
            ...
            if (isNullError() == false) {
                w = this.estimationErrorWeight.window.getWidth();
            }
            return w;
        }
        ...
        public void learnFromInstance(Instance inst, HoeffdingSeedTree ht, SplitNode parent, int parentBranch) {
            ...
            if (this.estimationErrorWeight == null) {
                this.estimationErrorWeight = new SEED((double) ht.deltaSEEDOption.getValue(),
                        ht.blockSizeSEEDOption.getValue(),
                        (double) ht.epsilonPrimeSEEDOption.getValue(),
                        (double) ht.alphaSEEDOption.getValue(),
                        ht.compressTermSEEDOption.getValue());
            }
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        @Override
        public double getErrorWidth() {
            return this.estimationErrorWeight.window.getWidth();
        }
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
            double[] dist;
            int predictionOption = ((HoeffdingSeedTree) ht).leafpredictionOption.getChosenIndex();
