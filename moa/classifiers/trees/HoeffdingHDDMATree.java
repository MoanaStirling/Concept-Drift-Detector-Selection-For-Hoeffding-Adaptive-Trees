...
import moa.classifiers.core.driftdetection.HDDM_A;
...
public class HoeffdingHDDMATree extends HoeffdingTree {
    ...
    public FloatOption driftConfidenceOption = new FloatOption("driftConfidence", 'v',
 ...
 /*   public MultiChoiceOption leafpredictionOption = new MultiChoiceOption(
    ...
    public interface NewNode {
        ...
        public void killTreeChilds(HoeffdingHDDMATree ht);

        public void learnFromInstance(Instance inst, HoeffdingHDDMATree ht, SplitNode parent, int parentBranch);
    ...
    public static class AdaSplitNode extends SplitNode implements NewNode {
        ...
        protected HDDM_A estimationErrorWeight;
        ...
        public void learnFromInstance(Instance inst, HoeffdingHDDMATree ht, SplitNode parent, int parentBranch) {
            ...
            if (this.estimationErrorWeight == null) {
                this.estimationErrorWeight = new HDDM_A(ht.driftConfidenceOption.getValue(), ht.warningConfidenceOption.getValue(), ht.oneSidedTestOption.getChosenIndex() == 1);
            }
    ...
    public static class AdaLearningNode extends LearningNodeNBAdaptive implements NewNode {
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
            double[] dist;
            int predictionOption = ((HoeffdingHDDMATree) ht).leafpredictionOption.getChosenIndex();
